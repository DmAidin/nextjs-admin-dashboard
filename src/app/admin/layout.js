                ...
                <div className="dropdown-menu dropdown-option dropdown-menu-end shadow">
                  ...
                  <div>
                    <a
                      ...
                      href="javascript:;"
                    >
                      <i className="material-icons-outlined fs-6">grade</i>چه
                      خبر است؟
                    </a>
                  </div>
                  <div>
        ...
        <li className="nav-item dropdown">
          ...
          <div className="dropdown-menu dropdown-user dropdown-menu-end shadow">
            ...
            <a
              ...
              href="javascript:;"
            >
              <i className="material-icons-outlined">person_outline</i>پروفایل
            </a>
            <a
              className="dropdown-item d-flex align-items-center gap-2 py-2"
              href="javascript:;"
            ...
            <a
              ...
              href="javascript:;"
            >
              <i className="material-icons-outlined">account_balance</i>درآمد
            </a>
            <a
              className="dropdown-item d-flex align-items-center gap-2 py-2"
              href="javascript:;"
            >
              <i className="material-icons-outlined">cloud_download</i>دانلودها
            </a>
            <hr className="dropdown-divider" />
            <a
              className="dropdown-item d-flex align-items-center gap-2 py-2"
              href="javascript:;"
            >
              <i className="material-icons-outlined">power_settings_new</i>خروج
            </a>
          </div>
        </li>
      </ul>
      ...
      <ul className="metismenu" id="sidenav">
          ...
          <ul>
            <li>
              <a href="app-emailbox.html">
                <i className="material-icons-outlined">arrow_left</i>جعبه ایمیل
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="app-to-do.html">
                <i className="material-icons-outlined">arrow_left</i>لیست کارها
              </a>
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <a href="component-accordions.html">
                <i className="material-icons-outlined">arrow_left</i>اکاردیون‌ها
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="component-carousels.html">
                <i className="material-icons-outlined">arrow_left</i>کاروسل‌ها
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="component-navs-tabs.html">
                <i className="material-icons-outlined">arrow_left</i>ناوبری و
                تب‌ها
              </a>
            </li>
            <li>
              <a href="component-navbar.html">
                <i className="material-icons-outlined">arrow_left</i>نوار ناوبری
              </a>
            </li>
            <li>
              <a href="component-paginations.html">
                <i className="material-icons-outlined">arrow_left</i>صفحه‌بندی
              </a>
            </li>
            <li>
              <a href="component-popovers-tooltips.html">
                <i className="material-icons-outlined">arrow_left</i>پاپ‌اورها و
                ابزارها
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="component-spinners.html">
                <i className="material-icons-outlined">arrow_left</i>چرخاننده‌ها
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="component-avtars-chips.html">
                <i className="material-icons-outlined">arrow_left</i>نماد های
                آواتار
              </a>
            </li>
            <li>
              <a href="component-typography.html">
                <i className="material-icons-outlined">arrow_left</i>تایپوگرافی
              </a>
            </li>
            <li>
              <a href="component-text-utilities.html">
                <i className="material-icons-outlined">arrow_left</i>ابزارهای
                متنی
              </a>
            </li>
          </ul>
          ...
          <ul>
            <li>
              <a href="icons-line-icons.html">
                <i className="material-icons-outlined">arrow_left</i>آیکون‌های
                خطی
              </a>
            </li>
            <li>
          ...
          <ul>
            <li>
              <a href="form-elements.html">
                <i className="material-icons-outlined">arrow_left</i>عناصر فرم
              </a>
            </li>
            <li>
              <a href="form-input-group.html">
                <i className="material-icons-outlined">arrow_left</i>گروه‌های
                ورودی
              </a>
            </li>
            <li>
              <a href="form-radios-and-checkboxes.html">
                <i className="material-icons-outlined">arrow_left</i>رادیوها و
                چک‌باکس‌ها
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="form-validations.html">
                <i className="material-icons-outlined">arrow_left</i>اعتبارسنجی
                فرم
              </a>
            </li>
            <li>
              <a href="form-wizard.html">
                <i className="material-icons-outlined">arrow_left</i>جادوگر فرم
              </a>
            </li>
            <li>
              <a href="form-file-upload.html">
                <i className="material-icons-outlined">arrow_left</i>بارگذاری
                فایل
              </a>
            </li>
            <li>
              <a href="form-date-time-pickes.html">
                <i className="material-icons-outlined">arrow_left</i>انتخابگرهای
                تاریخ و زمان
              </a>
            </li>
            <li>
              <a href="form-select2.html">
                <i className="material-icons-outlined">arrow_left</i>انتخابگر2
              </a>
            </li>
            <li>
              <a href="form-repeater.html">
                <i className="material-icons-outlined">arrow_left</i>تکرارکننده
                فرم
              </a>
            </li>
          </ul>
          ...
          <ul>
            <li>
              <a href="table-basic-table.html">
                <i className="material-icons-outlined">arrow_left</i>جدول پایه
              </a>
            </li>
            <li>
              <a href="table-datatable.html">
                <i className="material-icons-outlined">arrow_left</i>جدول داده
              </a>
            </li>
          </ul>
        </li>
        ...
        <li>
          ...
          <ul>
              ...
              <ul>
                <li>
                  <a href="auth-basic-login.html" target="_blank">
                    <i className="material-icons-outlined">arrow_left</i>ورود
                  </a>
                </li>
                <li>
                  <a href="auth-basic-register.html" target="_blank">
                    <i className="material-icons-outlined">arrow_left</i>ثبت‌نام
                  </a>
                </li>
                <li>
                  <a href="auth-basic-forgot-password.html" target="_blank">
                    <i className="material-icons-outlined">arrow_left</i>فراموشی
                    رمز عبور
                  </a>
                </li>
                <li>
                  <a href="auth-basic-reset-password.html" target="_blank">
                    <i className="material-icons-outlined">arrow_left</i>تنظیم
                    مجدد رمز عبور
                  </a>
                </li>
              </ul>
            ...
            <li>
              <a className="has-arrow" href="javascript:;">
                <i className="material-icons-outlined">arrow_left</i>باکس‌دار
              </a>
              <ul>
                <li>
          ...
          <ul>
            <li>
              <a href="pages-error-404.html" target="_blank">
                <i className="material-icons-outlined">arrow_left</i>خطای 404
              </a>
            </li>
            <li>
              <a href="pages-error-505.html" target="_blank">
                <i className="material-icons-outlined">arrow_left</i>خطای 505
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="pages-starter-page.html" target="_blank">
                <i className="material-icons-outlined">arrow_left</i>صفحه خالی
              </a>
            </li>
          </ul>
        </li>
          ...
          <ul>
            <li>
              <a href="charts-apex-chart.html">
                <i className="material-icons-outlined">arrow_left</i>Apex Chart
              </a>
            </li>
            <li>
              <a href="charts-chartjs.html">
                <i className="material-icons-outlined">arrow_left</i>Chart JS
              </a>
            </li>
          </ul>
        </li>
          ...
          <ul>
            <li>
              <a href="map-google-maps.html">
                <i className="material-icons-outlined">arrow_left</i>نقشه‌های
                گوگل
              </a>
            </li>
            <li>
          ...
          <ul>
            <li>
              ...
              <ul>
                <li>
                  <a className="has-arrow" href="javascript:;">
                    <i className="material-icons-outlined">arrow_left</i>سطح دو
                  </a>
                  <ul>
                    <li>
                      <a href="javascript:;">
